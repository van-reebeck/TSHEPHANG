...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By TSHEPHANG' : process.env.ALL_CAPTION,
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'TSHEPHANG' : process.env.OWNER_NAME,
    ...
    SUDO: process.env.SUDO === undefined ? '27634923280' : process.env.SUDO,
    DEBUG: DEBUG,
